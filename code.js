...
function startNewHost() {
 ...
 if(window.ononline){document.getElementById("startScreen").style.display="none"; return; }
 peer = new Peer(hostId, {host:'0.peerjs.com', port:443, path:'/'});
 isHost = true;
...
document.getElementById("joinConfirm").addEventListener("click", ()=>{
 ...
 if(!id) return;
 peer = new Peer(generateRandomId(), {host:'0.peerjs.com', port:443, path:'/'});
 peer.on('open', ()=>{
